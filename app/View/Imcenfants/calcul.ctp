				...
				<tr>
					<td>
						...
						<?php if ($_POST['zt_age'] > 18): ?>
							...
							echo("Vous êtes en surcharge pondérale <br/> Souhaitez-vous perdre du poids ?");
							echo("<br/> <br/><A href=\"javascript:popup('view/IMC.php')\" onclick=\"popup('IMC.php')\"><input type=\"submit\" value=\"Oui\"></A>
