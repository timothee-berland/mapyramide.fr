			...
			<table>
				<tr>
					<td>
						<h1>Résultat</h1>
						<br/> <br />
						<p2>Mon IMC est : <?php echo round($imc,2);?></p2>
						<p2>Mes besoins énergétiques estimés sont de <?php echo $BEE ?> calories par jour.</p2>
						<br/><br/>
...
<script type="text/javascript">
	jQuery(document).ready(function($){
	    ...
	    $('#blocQuestion #m').click(function(e){
	        ...
	        document.getElementById('besoinsEnergetiques').innerHTML = "Mes nouveaux besoins énergétiques conseillés</p1><p1>sont de " + newBEE + " calories par jour.";
	    });
