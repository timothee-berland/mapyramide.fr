<div id="presentation">
    ...
    <div id="texte">
		<!-- Cette page est accessible à partir du menu situé en haut de page : Cliquez sur "Poids et calories" ->"Gestion pondérale" ->"Aliments nécessaires"
		     Elle donne des conseils sur les aliments dont l'utilisateur à besoin -->
		<span> Les aliments  </span> <br/>
		<span> dont j'ai besoin </span> <br/>
		<br />
