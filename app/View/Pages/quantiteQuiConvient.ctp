<div id="presentation">
    ...
    <div id="texte">
		<!-- Cette page est accessible à partir du menu situé en haut de page : Cliquez sur "Poids et calories" ->"Gestion pondérale" ->"Quantite"
		     Elle donne des conseils sur la quantité de calories recommandée en fonction des personnes -->
		<span> La quantité de calories  </span> <br/>
		<span> qui me convient  </span> <br/>
		<br />
