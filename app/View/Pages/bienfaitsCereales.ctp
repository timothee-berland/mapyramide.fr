<div id="presentation">
    ...
    <div id="texte">
		<!-- Cette page est accessible à partir du menu situé en haut de page : Cliquez sur "Mon assiette" ->"Céréales" ->"Bienfaits des céréales"
		     Elle présente les effets bénéfiques qu'ont les céréales sur notre santé -->
		<span> L'importance de manger </span> <br/>
		<span> des céréales </span> <br/>
		<h1>Introduction </h1>
	...
	<div id="texte0">
		<table>
			<tr>
				<td >
					<h1>Bienfaits des céréales sur la santé</h1>
